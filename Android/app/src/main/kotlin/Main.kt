...
internal val logger: SkipLogger = SkipLogger(subsystem = "stamp.ix", category = "StampIX")

private typealias AppRootView = StampIXRootView
private typealias AppDelegate = StampIXAppDelegate
